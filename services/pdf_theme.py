...
----------------------
Shared ReportLab styling constants and a branded page template
...
# ---------------------------------------------------------------------
# Brand colors (matching static/css/style.css :root variables)
# ---------------------------------------------------------------------
...
def draw_header_footer(canvas, doc):
    ...
    SimpleDocTemplate. Draws a navy header banner with the brand logo and
