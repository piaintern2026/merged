...
class Evaluation(db.Model):
    ...
    # Soft-delete flag. Evaluations are part of an intern's permanent
    # performance record and are never hard-deleted; HR/Super Admin can
    # disable one instead (e.g. to correct a duplicate) while preserving
    # the record for audit/history purposes.
