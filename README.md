...
A full-stack Flask web application to manage the
...
│
└── static/
    ├── css/style.css              # Green/white brand theme
...
containing: a brand logo placeholder, an auto-incrementing certificate number
(`IOP-CERT-<year>-<sequence>`, prefix configurable in Settings), intern name,
...
Built as an internal internship-onboarding management tool.
This is an internal engineering exercise and not an official production system.
