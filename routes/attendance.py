...
reports; only an Admin may correct a record. HR can view
...
# ----------------------------------------------------------------------
# Admin only: edit an existing attendance record.
# HR and Project Managers have view-only access to attendance history --
# only an Admin may correct a previously marked record.
# ----------------------------------------------------------------------
@attendance_bp.route("/edit/<int:attendance_id>", methods=["GET", "POST"])
@login_required
@roles_required("Admin")
def edit_attendance(attendance_id):
    """Edit an existing attendance record. Restricted to Admin."""
...
# ----------------------------------------------------------------------
# Shared listing: HR, Project Manager and Admin all get a
# view-only listing of every intern's attendance -- only an Admin
...
@attendance_bp.route("/")
@login_required
@roles_required("Station HR", "Project Manager", "Admin")
def list_attendance():
