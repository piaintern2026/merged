...
def _city_department_matrix(cities=None) -> dict:
    ...
    omitted, every PIA city is included (Super Admin's unrestricted view).
    """
...
def _department_summary_rows(cities=None) -> list:
    ...
    scoping); Super Admin passes None for every department.
...
def index():
    ...
    HR sees data scoped to their assigned city; Super Admin sees
