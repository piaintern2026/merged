...
def index():
    ...
    if current_user.role in ("Station HR", "Super Admin"):
        ...
        # applicable (Super Admin always sees the whole organisation).
        ...
        # Super Admin sees every known city (even zero-intern ones); a
