...
def list_projects():
    """Show projects. Admin sees everything; Station HR sees only
    ...
    if current_user.role == "Project Manager":
        ...
        # Station HR / Admin filters via query string
...
def add_project():
    ...
    if request.method == "POST":
        ...
        # HR/Admin: enforce the City -> Department -> PM cascade
        ...
        # HR/Admin may only hand it to interns in the chosen
