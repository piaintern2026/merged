...
own assigned interns/projects -- HR/Admin may view for oversight
but only the owning PM (or Admin) may create/edit/delete.
"""
...
def _get_owned_project(project_id):
    ...
    Admin bypasses ownership (handled by roles_required)."""
...
def milestones(project_id):
    ...
    can_manage = current_user.role in ("Project Manager", "Admin")
...
@login_required
@roles_required("Project Manager", "Admin")
