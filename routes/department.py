...
def add_department():
    ...
    if request.method == "POST":
        ...
        # Division/Section is entirely optional here -- Super Admin can
...
def edit_department(department_id):
    """Edit an existing department: name, city, and status. Super Admin
...
def delete_department(department_id):
    """Permanently delete a department. Super Admin only -- unlike
